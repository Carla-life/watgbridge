...
var AllConfigOptions = slices.Concat(
	[]ConfigOption{
		...
		{
			Name:        "pack_name",
			Description: "This is the pack name which will be set for the stickers sent to WhatsApp from Telegram.",
			Required:    false,
			Mutable:     true,
			Default:     "WaTgBridge",
			Type:        reflect.TypeOf(""),
		...
		{
			Name:        "author_name",
			Description: "This is the pack author name which will be set for the stickers sent to WhatsApp from Telegram.",
			Required:    false,
			Mutable:     true,
			Default:     "WaTgBridge",
			Type:        reflect.TypeOf(""),
		...
		{
			Name:        "only_releases",
			Description: "If set to `false` then the bot will also notify if there are new commits on GitHub but a new version release has not been made.",
			Required:    false,
			Mutable:     true,
			Default:     true,
			Type:        reflect.TypeOf(false),
